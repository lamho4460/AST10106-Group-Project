...
public class ImageFrame extends JFrame implements ActionListener, ChangeListener, MouseMotionListener, MouseListener {
	...
	public ImageFrame(String title) {
		...
		openButton = new JButton(new ImageIcon(ImageFrame.class.getResource("icons/icons/TreeOpen.gif")));
		//openButton.setIcon(new ImageIcon(ImageFrame.class.getResource("icons/TreeOpen.gif")));
		openButton.addActionListener(this);
		
		saveButton = new JButton(new ImageIcon(ImageFrame.class.getResource("icons/icons/FloppyDrive.gif")));
		//saveButton.setIcon(new ImageIcon(ImageFrame.class.getResource("icons/FloppyDrive.gif")));
		saveButton.addActionListener(this);
		
		undoButton = new JButton(new ImageIcon(ImageFrame.class.getResource("icons/icons/Undo_16x16_JFX.png")));
		//undoButton.setIcon(new ImageIcon(ImageFrame.class.getResource("icons/Undo_16x16_JFX.png")));
		undoButton.addActionListener(this);
		
		redoButton = new JButton(new ImageIcon(ImageFrame.class.getResource("icons/icons/Redo_16x16_JFX.png")));
		//redoButton.setIcon(new ImageIcon(ImageFrame.class.getResource("icons/Redo_16x16_JFX.png")));
